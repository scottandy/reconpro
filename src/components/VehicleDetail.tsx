...
const VehicleDetail: React.FC = () => {
  ...
  const [rightPanelView, setRightPanelView] = useState<'inspection' | 'notes'>('inspection');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        ...
        {(vehicle.isSold || vehicle.isPending) && (
          <div className={`p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg border mb-6 ${
            vehicle.isSold 
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
          {/* Left Column (1/3) - Only visible on desktop */}
          <div className="hidden lg:block lg:w-1/3 space-y-6">
            ...
            {/* Vehicle Information Card - Desktop */}
            <div className="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg border border-white/20 p-4 sm:p-6">
          ...
          {/* Mobile Reconditioning Progress - Only visible on mobile */}
          ...
          {/* Right Column (2/3) or Full Width on Mobile */}
          <div className="w-full lg:w-2/3 space-y-6">
            {/* Toggle Switch for Inspection/Notes */}
        ...
        {/* Mobile Vehicle Information Card - Only visible on mobile at the bottom */}
